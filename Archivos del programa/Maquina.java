...
class  Maquina {
   ...
   void forcode(){
      ...
      execute(((Integer)prog.elementAt(savepc)).intValue());/* condition */
      d=((Boolean)pila.pop()).booleanValue();
      while (d) {
   ...
   //Función para el comando subir de logo
   void upPencil(){
      double d1;
      d1=((Double)pila.pop()).doubleValue();
      //y = y - (int)d1 ;
   ...
   //Función para el comando bajar de logo
   void downPencil(){
      double d1;
      d1=((Double)pila.pop()).doubleValue();
      //y = y + (int)d1 ;
   ...
   //Función para el comando cambiar color de logo
   void color(){
      double d1, d2, d3;
      d1=((Double)pila.pop()).doubleValue();
